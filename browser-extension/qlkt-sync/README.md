...
2. Giữ tab công tơ QLKT này đang mở. Mở `https://ctktkt-dashboard.vercel.app/ppa-heat-rate` và nhấn F5. Trang phải báo **Tiện ích v0.4.16 đã kết nối**.
