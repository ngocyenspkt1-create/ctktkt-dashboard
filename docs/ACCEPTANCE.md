...
- Web kiểm tra phiên bản tiện ích trước khi đồng bộ. Nếu đang kết nối bản thấp hơn `0.4.27`, nút đổi thành **Cập nhật tiện ích 0.4.27**, tự tải ZIP với tham số chống cache và không cho bản cũ tiếp tục đồng bộ. Chrome/Edge vẫn yêu cầu người dùng giải nén và Reload/Load unpacked vì trang web không có quyền tự cài đè tiện ích trình duyệt.
